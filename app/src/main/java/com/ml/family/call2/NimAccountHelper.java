...
//        });
    ...
    public String getAccount() {
        return LocalShared.getInstance(CustomApplication.getInstance()).getNimAccount();
    }

    public String getToken() {
        return LocalShared.getInstance(CustomApplication.getInstance()).getNimToken();
    }

    public void setAccount(String account) {
        mAccount = account;
        LocalShared.getInstance(CustomApplication.getInstance()).setNimAccount(account);
    }

    public void setToken(String token) {
        mToken = token;
        LocalShared.getInstance(CustomApplication.getInstance()).setNimToken(token);
    }

    public static void removeUserInfo() {
        LocalShared.getInstance(CustomApplication.getInstance()).setNimAccount(null);
        LocalShared.getInstance(CustomApplication.getInstance()).setNimToken(null);
    }
}
